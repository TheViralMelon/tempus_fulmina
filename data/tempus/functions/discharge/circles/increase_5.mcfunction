...
# say running increase_5.mcfunction ...

#> Circle particles
# execute positioned ^ ^ ^2 run particle end_rod ~ ~ ~ 0 0 0 0 1 force @a
# execute positioned ^ ^ ^-2 run particle end_rod ~ ~ ~ 0 0 0 0 1 force @a
execute as @s[tag=!tempus.DischargeFinish] positioned ^ ^ ^10 run particle crit ~ ~ ~ 0 0 0 0 1 force @a
execute as @s[tag=!tempus.DischargeFinish] positioned ^ ^ ^-10 run particle crit ~ ~ ~ 0 0 0 0 1 force @a
execute as @s[tag=tempus.DischargeFinish] positioned ^ ^ ^10 run particle end_rod ~ ~ ~ 0 0 0 0 1 force @a
execute as @s[tag=tempus.DischargeFinish] positioned ^ ^ ^-10 run particle end_rod ~ ~ ~ 0 0 0 0 1 force @a
scoreboard players remove #circleTick tempus.dummy1 1
execute if score #circleTick tempus.dummy1 matches 0.. rotated ~6 ~ run function tempus:discharge/circles/increase_5
...
execute as @s[tag=tempus.SphereTicking] rotated ~ ~-18 run function tempus:discharge/circles/increase_5